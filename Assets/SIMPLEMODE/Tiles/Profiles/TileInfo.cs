...
public class TileInfo
{
    ...
    [HideInInspector] public TileController _Controller;
    ...
    public string DescriptionPreview => GetGenericSkillsText() + GetTooltipText();
    ...
    public void Initialize()
    {
        ...
        tileMovement = _Controller.tileMovement;
    }
    ...
    {
        _Controller.SetBaseDamage(BaseDamage + addedDamage);
        return addedDamage;
    }
    public virtual float RemoveBaseDamage(float removedDamage)
    {
        ...
        _Controller.SetBaseDamage(BaseDamage - removedDamage);
